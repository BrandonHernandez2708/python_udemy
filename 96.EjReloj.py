...
class RelojDigital:
    def __init__(self, ventana):
        ...
        self.btn_iniciar_cronometro = tk.Button(ventana, text="Iniciar Cronómetro", command=self.iniciar_cronometro)
        self.btn_iniciar_cronometro.pack()
        self.btn_detener_cronometro = tk.Button(ventana, text="Detener Cronómetro", command=self.detener_cronometro,state="disabled")
    ...
    def iniciar_reloj(self):
        ...
        self.ventana.after(1000, self.iniciar_reloj)
    ...
    def activar_alarma(self):
        ...
        if hora_actual == self.hora_alarma:
            messagebox.showinfo("Alarma", "Es la hora que indicaste")
        else:
