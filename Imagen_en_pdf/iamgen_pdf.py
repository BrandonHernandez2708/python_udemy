...
def añadir_imagen(pdf_original,pdf_final,imagen_png, x ,y,ancho,alto):
    ...
    pagina.insert_image(img_rect, pixmap=imagen[0].get_pixmap())  
...
if __name__ == "__main__":
    pdf_origninal = "prueba.pdf"
    pdf_final = "prueba_con_imagen.pdf"
    imagen_png = "imagen.jpg"
    x = 50
    y = 50
    ancho = 200
    alto = 150
    añadir_imagen(pdf_origninal, pdf_final, imagen_png, x, y, ancho, alto)
