...
print(matriz[:2]) # primeras dos filas
print(matriz[1, 2]) # elemento fila 1, columna 2
print(matriz[:, 1]) # segunda columna
print(matriz[:, :1])    # primera columna
print(matriz)
print(matriz+10)
print(matriz+matriz) # suma de matrices
print(matriz*10)
print(matriz*matriz) # multiplicacion de matrices
print(np.max(matriz))
...
print("mostrando lista dimension modificada 3x12")
print(lista)
print("mostrando indice 2,4")
print(lista[2,4])

#combinacion primitiva
arrayPrimitiva = np.random.randint(1,50,6)
print(f"la combinacion ganadora de la primitiva es {arrayPrimitiva}")